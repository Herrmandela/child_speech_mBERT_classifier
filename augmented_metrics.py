...
# Load the dataset into a pandas dataframe.  # 1
    ...
    df = pd.read_csv("/data/english/englishData.csv",
                     on_bad_lines='skip',
                     encoding='ISO-8859-1')
...
def augmented_load_farsi():           # 1
    ...
    df = pd.read_excel("/data/farsi/farsiMLC.xls")
...
def augmented_load_greek():         # 1
    ...
    df = pd.read_csv("/data/greek/greekData.csv",
                     on_bad_lines='skip',
                     sep = ",")
...
def augmented_load_all():           # 1
    ...
    df = pd.read_csv("/Users/ph4533/Desktop/PyN4N/Py38/gn4n/data/multilingual/allDataCELF.csv",
...
def augmented_load_validation():
    ...
    All_text = pd.read_csv("/data/multilingual/allDataCELF.csv",
                          keep_default_na=False,
                          sep = ";")
